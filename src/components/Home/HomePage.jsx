      ...
      <div>
        {
          ...
          <section>
            <h1>Bienvenidos</h1>
            <h3>No había sido un error; recordaba perfectamente la posición de las piezas; recordaba también que su movimiento no sólo liberaba al rey del jaque, sino que ponía a las negras a la ofensiva; recordaba, por supuesto, que el movimiento era absolutamente válido y que, al momento de pensarlo, le había parecido obvio, casi fatal. El problema era que, al día siguiente, al querer reproducir la jugada, no sólo descubrió que la había olvidado, sino que era por completo imposible: el rey negro no sólo estaba en jaque, sino en jaque mate</h3>
          </section>
          :
          <section>
            <h1>Welcome</h1>
