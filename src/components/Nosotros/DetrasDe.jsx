    ...
    <>
    {
        ...
        <div className="container-nosotros detrasDe">
            <div className="seccion-detras">
                ...
                <p>Soy Dan. El fútbol marca el termómetro de mi vida. Voy a la cancha desde que tengo uso de razón. Con mi papá, compartimos muchos viajes en moto yendo a conocer distintas canchas. Y hubo algo que siempre me llamó la atención: cómo 11 personas que patean una pelota movilizan tanta gente, a viajar miles de kilómetros por su equipo, a juntar a toda una familia en el sillón a ver un partido, a endiosar a figuras como Messi o Maradona, a ser el ser humano más feliz por una victoria y el más angustiado por una derrota. Yo no supe responder esa pregunta aún. ¿Qué es lo genera tanta locura, tanta emoción y tanto fanatismo? En esta experiencia futbolera, te invito a que encontremos juntos la respuesta.</p>
            </div>
            <img src="src/img/nosotros-dan.png" alt="Dan en la tribuna" />
        </div>
        :
        <div className="container-nosotros detrasDe">
            <div className="seccion-detras">
